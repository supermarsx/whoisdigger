...
impl RegistrarRegistry {
    pub fn new() -> Self { Self { registrars: HashMap::new() } }
    ...
    pub fn with_capability(&self, cap: &RegistrarCapability) -> Vec<&Registrar> {
        self.registrars.values().filter(|r| r.capabilities.contains(cap)).collect()
    }
    ...
    pub fn len(&self) -> usize { self.registrars.len() }
    pub fn is_empty(&self) -> bool { self.registrars.is_empty() }
}
...
fn builtin_registrars() -> Vec<Registrar> {
    vec![
        Registrar {
            ...
            capabilities: vec![
                RegistrarCapability::Registration, RegistrarCapability::Transfer,
                RegistrarCapability::Renewal, RegistrarCapability::DnsManagement,
                RegistrarCapability::WhoisPrivacy, RegistrarCapability::BulkOperations,
                RegistrarCapability::ApiAccess, RegistrarCapability::AutoRenew,
            ],
            has_api: true,
        ...
        Registrar {
            ...
            capabilities: vec![
                RegistrarCapability::Registration, RegistrarCapability::Transfer,
                RegistrarCapability::DnsManagement, RegistrarCapability::DnsSec,
                RegistrarCapability::ApiAccess, RegistrarCapability::AutoRenew,
            ],
            has_api: true,
            purchase_supported: true,
        ...
        Registrar {
            ...
            capabilities: vec![
                ...
                RegistrarCapability::WhoisPrivacy, RegistrarCapability::BulkOperations,
                RegistrarCapability::ApiAccess, RegistrarCapability::AutoRenew,
                RegistrarCapability::EmailForwarding, RegistrarCapability::UrlForwarding,
            ],
            has_api: true,
            purchase_supported: true,
            affiliate_id: None,
        ...
        Registrar {
            ...
            capabilities: vec![
                RegistrarCapability::Registration, RegistrarCapability::Transfer,
                RegistrarCapability::Renewal, RegistrarCapability::DnsManagement,
                RegistrarCapability::WhoisPrivacy, RegistrarCapability::ApiAccess,
                RegistrarCapability::AutoRenew, RegistrarCapability::DnsSec,
            ],
            has_api: true,
            purchase_supported: true,
            affiliate_id: None,
        ...
        Registrar {
            ...
            capabilities: vec![
                RegistrarCapability::Registration, RegistrarCapability::Transfer,
                RegistrarCapability::Renewal, RegistrarCapability::DnsManagement,
                RegistrarCapability::ApiAccess, RegistrarCapability::BulkOperations,
            ],
            has_api: true,
            purchase_supported: true,
            affiliate_id: None,
        ...
        Registrar {
            ...
            capabilities: vec![
                RegistrarCapability::Registration, RegistrarCapability::Transfer,
                RegistrarCapability::DnsManagement, RegistrarCapability::WhoisPrivacy,
